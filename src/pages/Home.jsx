...
function Home() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)]">
      {isLoggedIn ? (
        <div className="bg-gradient-to-br from-primary-50 via-white to-secondary-50 py-20 px-4 sm:px-6 lg:px-8 text-center max-w-4xl mx-auto">
<h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
  Connecting students with experienced mentors.
</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Build your career, share your knowledge, and grow in the vast world of STEM.
          </p>
        </div>
      ) : (
        <>
