        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Connecting students with experienced mentors in STEM fields.
              Build your career, share your knowledge, and grow together in the world of science, technology, engineering, and mathematics.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} STEMLink. All rights reserved.
            </p>
